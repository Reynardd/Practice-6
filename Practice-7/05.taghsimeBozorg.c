#include <stdio.h>
#include <string.h>
int sign(char ch[53]) { return !(ch[0] - '-') ? -1 : 1; }
...
void strToInt(char input[53], int target[100]) {
...
void divide(char num1[53], char num2[53]) {
    int number1[100], number2[100], result[100] = { 0 };
